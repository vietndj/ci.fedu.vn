...
const LANTAN_FAQS = [
  {
    q: "1. \"Tôi không biết lập trình / code thì có cài đặt và dùng được AI Agent không?\"",
  ...
  {
    q: "2. \"Tôi dùng máy tính cấu hình bình thường hoặc MacBook cũ có chạy được không?\"",
  ...
  {
    q: "3. \"AI viết kịch bản có bị cứng nhắc, sáo rỗng giống bài ChatGPT thông thường?\"",
  ...
  {
    q: "4. \"Tôi bận đi làm cả ngày, khóa học có mất nhiều thời gian không?\"",
